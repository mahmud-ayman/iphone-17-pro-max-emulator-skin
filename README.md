...
## 📸 Preview
<p align="center">
  <img src="screenshots/BLUE.png" width="49%" alt="iPhone 17 Pro Max - Blue Titanium" />
  <img src="screenshots/BLACK.png" width="49%" alt="iPhone 17 Pro Max - Black Titanium" />
</p>
...
You are free to use, modify, and share this skin for personal or commercial projects — **but you must give credit**.

**Attribution Required:** If you use this design, you must mention the original source and include a link back to this repository. Do not claim it as your own.

**بالعربي:** يُسمح باستخدام التصميم مع ضرورة ذكر المصدر ورابط الريبو الأصلي عند النشر أو التعديل.
